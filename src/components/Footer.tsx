  ...
  return (
    <footer>
      ...
      <div className="mt-8 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
        <div
          className="
            bg-white border-2 border-gray-200 rounded-3xl shadow-lg/20
            px-6 py-5
        ...
        >
          ...
          <div className="flex flex-col items-center sm:items-end gap-2">
            ...
            <div className="flex flex-wrap justify-center inset-shadow-sm/25 ring ring-[#0084ff] rounded-2xl bg-gray-50 py-4 px-3 sm:justify-end gap-2 text-[13px]">
              {[
                ...
                <a
                  ...
                  className="
                    ...
                    hover:shadow-md/20 border-2 border-gray-200
                  "
                >
                  {link.label}
                </a>
